...
export default function LoginPage() {
  const handleGoogleLogin = async () => {
    await signIn("google", { callbackUrl: "/Products?login=success" });
  };
  ...
  const handleCredentialsLogin = async (e) => {
    ...
    await signIn("credentials", {
      email,
      password,
      callbackUrl: "/Products?login=success",
    });
  };
      ...
      <div className="min-h-screen flex items-center justify-center">
        <div className="card w-full max-w-md bg-base-100 shadow-md">
          <div className="card-body">
            {/* Header */}
            <h2 className="text-3xl font-bold text-center mb-11">Login</h2>
            ...
            <form onSubmit={handleCredentialsLogin} className="flex flex-col gap-3">
              ...
              <button
                type="submit"
                className="btn bg-emerald-500 hover:bg-emerald-600 border border-emerald-700 w-full"
              >
                Login
              </button>
            </form>
